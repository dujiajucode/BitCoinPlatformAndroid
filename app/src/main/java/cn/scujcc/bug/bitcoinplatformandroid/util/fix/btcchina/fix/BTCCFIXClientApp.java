...
//import com.scujcc.bug.fixdemo.Config;
...
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.LIMIT, 10000, 0.0001,
//					// "BTCCNY"); // integer not supported??
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.LIMIT, 1001.1, 2.1,
//					// "BTCCNY"); //
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.BUY, OrdType.LIMIT, 1000, 0.0001,
//					// "BTCCNY"); //
//
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.LIMIT, 1001.1, 0.001,
//					// "LTCCNY"); //
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.BUY, OrdType.LIMIT, 1, 0.001, "LTCCNY");
//					// //
//
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.LIMIT, 1001.1, 0.001,
//					// "LTCBTC"); //
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.BUY, OrdType.LIMIT, 0.0001, 0.001,
//					// "LTCBTC"); //
//
//					// market order sell/buy
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.MARKET, 0.0001d,
//					// "BTCCNY");
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.BUY, OrdType.MARKET, 0.0001d, "BTCCNY");
//
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.MARKET, 0.001d, "LTCCNY");
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.BUY, OrdType.MARKET, 0.001d, "LTCCNY");
//
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.SELL, OrdType.MARKET, 0.001d, "LTCBTC");
//					// message = tradeRequest.createNewOrderSingle(ACCESS_KEY,
//					// SECRET_KEY, Side.BUY, OrdType.MARKET, 0.001d, "LTCBTC");
//
//					// cancel an order
//					// message =
//					// tradeRequest.createOrderCancelRequest(ACCESS_KEY,
//					// SECRET_KEY, 42664407, "BTCCNY");
//
//					// get account info
//					// message =
//					// tradeRequest.createUserAccountRequest(ACCESS_KEY,
//					// SECRET_KEY);
//
//					// get order
//					// message =
//					// tradeRequest.createOrderStatusRequest(ACCESS_KEY,
//					// SECRET_KEY, "BTCCNY",42663920);
//
